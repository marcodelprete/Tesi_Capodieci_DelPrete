// ======================================================================
// Albumin_Measurement_Potentiostat.v generated from TopDesign.cysch
// 05/05/2022 at 16:33
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=125, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2000, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC_VG, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_VG, CY_INSTANCE_SHORT_NAME=VDAC_VG, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC_VG, )
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("dcee0ffb-996d-4ba8-888b-3a944d93829d/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("dcee0ffb-996d-4ba8-888b-3a944d93829d/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
// IDAC8_v2_0(Current=18, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=2, Initial_Value=144, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC_Calibration, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_Calibration, CY_INSTANCE_SHORT_NAME=IDAC_Calibration, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC_Calibration, )
module IDAC8_v2_0_3 (
    data,
    en,
    iOut,
...
// DVDAC_v2_10(DAC_Range=4, Initial_Value=2000, InternalClock=true, InternalClockFreqHz=250000, Resolution=12, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DVDAC_v2_10, CY_CONFIG_TITLE=DVDAC_SetV, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC_SetV, CY_INSTANCE_SHORT_NAME=DVDAC_SetV, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=DVDAC_SetV, )
module DVDAC_v2_10_5 (
    clock,
    Vout);
    input       clock;
    inout       Vout;
	...
	cy_clock_v1_0
		#(.id("4db5c09e-44e7-4b29-8bc5-e69885cb338b/16079296-677d-4c97-a0f1-fd79fcfb8c33"),
	...
	cy_clock_v1_0
		#(.id("4db5c09e-44e7-4b29-8bc5-e69885cb338b/2b3078c1-9a14-4aea-bb80-3826ca4e0c90"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=2, CompareType2Software=0, CompareValue1=0, CompareValue2=1, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=7199, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_isr, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_isr, CY_INSTANCE_SHORT_NAME=PWM_isr, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_isr, )
module PWM_v3_30_6 (
    capture,
    clock,
    cmp_sel,
...
module top ;
    ...
    VDAC8_v1_90_1 VDAC_VG (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_126));
    defparam VDAC_VG.Data_Source = 0;
    defparam VDAC_VG.Initial_Value = 125;
    defparam VDAC_VG.Strobe_Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("686ada75-35d1-44dd-b0b5-c707080dcffa"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam AMux_Cur.muxin_width = 2;
    defparam AMux_Cur.init_mux_sel = 2'h0;
    defparam AMux_Cur.one_active = 0;
    defparam AMux_Cur.connect_mode = 2;
    
    // -- AMux AMux_Cur end --

    IDAC8_v2_0_3 IDAC_Calibration (
        .data(8'b00000000),
        .en(1'b0),
        .iOut(Net_184),
        .ipolarity(1'b0),
        .strobe(1'b0));
    defparam IDAC_Calibration.Data_Source = 0;
    defparam IDAC_Calibration.Initial_Value = 144;
    defparam IDAC_Calibration.Strobe_Mode = 0;

	wire [0:0] tmpOE__Ext_Cap_Pin_net;
	wire [0:0] tmpFB_0__Ext_Cap_Pin_net;
	wire [0:0] tmpIO_0__Ext_Cap_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Ext_Cap_Pin_net;
	electrical [0:0] tmpSIOVREF__Ext_Cap_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Ext_Cap_Pin
		 (.oe(tmpOE__Ext_Cap_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ext_Cap_Pin_net[0:0]}),
		  .analog({Net_166}),
		  .io({tmpIO_0__Ext_Cap_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Ext_Cap_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Ext_Cap_Pin_net[0:0]}),
		  .annotation({Net_127}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Ext_Cap_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a6d5575f-2a85-47ba-89d2-959566ac5b27"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("c4aa423b-fd27-482d-8387-92d3d3cb5fde"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(100),
		  .period("0"),
		  .is_direct(0),
    ...
    OpAmp_v1_90_7 Opamp (
        ...
        .Vout(Net_208),
        .Vplus(Net_166));
    defparam Opamp.Mode = 0;

    // -- AMux AMux_Electrodes start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 AMux_Electrodes(
        .muxin({
            Net_171,
            Net_208
            }),
    ...
    defparam AMux_Electrodes.muxin_width = 2;
    defparam AMux_Electrodes.init_mux_sel = 2'h0;
    defparam AMux_Electrodes.one_active = 0;
    defparam AMux_Electrodes.connect_mode = 2;
    
    // -- AMux AMux_Electrodes end --

	wire [0:0] tmpOE__Referenece_Electrode_net;
	wire [0:0] tmpFB_0__Referenece_Electrode_net;
	wire [0:0] tmpIO_0__Referenece_Electrode_net;
	wire [0:0] tmpINTERRUPT_0__Referenece_Electrode_net;
	electrical [0:0] tmpSIOVREF__Referenece_Electrode_net;

	cy_psoc3_pins_v1_10
		#(.id("03ec2f5a-50f6-47e3-8ad2-a3b11e3ae0ac"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Referenece_Electrode
		 (.oe(tmpOE__Referenece_Electrode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Referenece_Electrode_net[0:0]}),
		  .analog({Net_171}),
		  .io({tmpIO_0__Referenece_Electrode_net[0:0]}),
		  .siovref(tmpSIOVREF__Referenece_Electrode_net),
		  .interrupt({tmpINTERRUPT_0__Referenece_Electrode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Referenece_Electrode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
